...
const ShowBook = () => {
  ...
  return (
  <div className="p-4 bg-no-repeat bg-cover w-full h-screen text-white" style={{backgroundImage: `linear-gradient(to right, rgba(50,50,50,0.4), rgba(0,0,0,0.2)),url(${ShopImage})`}}>
    <BackButton />
